...
- Main configuration: `/home/pi/Frame/.env`
...
The Frame runs as a systemd service. You can manage it with these commands:

```bash
# Check service status
sudo systemctl status frame.service
...
# View service logs
sudo journalctl -u frame.service -f
```
